...
// export const runtimeLib = ref(defaultVueUrl);
...
//   runtimeLib.value = defaultVueUrl;
// }

/**
 * 编译文件
 */
export async function compileVueFile({ filename, code, compiled }: File) {
  if (!code.trim()) {
    store.errors = [];
    return;
  }
